    ...
    <div className='flex flex-col gap-8'>
      ...
      <div className="flex gap-8">
        ...
        <p className="text-gray-500 font-medium">
          ...
          Sunt quod inventore ipsum veritatis non tenetur eius quasi earum,
          nemo asperiores magnam facilis! Asperiores animi error eius quasi beatae,
          consequuntur est?
        </p>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-12">
        ...
        <div className="lg:text-lg flex flex-col gap-6 text-justify">
          ...
          Sunt quod inventore ipsum veritatis non tenetur eius quasi earum,
          nemo asperiores magnam facilis! Asperiores animi error eius quasi beatae,
          consequuntur est?Lorem ipsum dolor sit amet consectetur adipisicing elit.
          Sunt quod inventore ipsum veritatis non tenetur eius quasi earum,
          nemo asperiores magnam facilis! Asperiores animi error eius quasi beatae,
          consequuntur est?Lorem ipsum dolor sit amet consectetur adipisicing elit.
          Sunt quod inventore ipsum veritatis non tenetur eius quasi earum,
        ...
        <div className="px-4 h-max sticky top-8">
          ...
          <div className="flex items-center rounded-full object-cover gap-8">
